...
int assemble_code(){
    int resulting_code_red = zhang::red::code_fragment()+khan::red::code_fragment()+garcia::red::code_fragment();
    int resulting_code_blue = zhang::blue::code_fragment()+khan::blue::code_fragment()+garcia::blue::code_fragment();

    return resulting_code_red*resulting_code_blue;
}
